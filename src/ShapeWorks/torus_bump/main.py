...
def run_torus_pipeline():

    mesh_files = sorted(glob.glob("torus_raw_data/*.ply"))[::1]
    ...
    project_location = "torus_shape_model/"
    if not os.path.exists(project_location):
        os.makedirs(project_location)
    # Remove particle dir if it already exists
    shape_model_dir = project_location + 'torus_particles/'
    ...
    spreadsheet_file = "torus_shape_model/torus.xlsx"
